...
### 2. Full Pipeline
```bash
python run_complete_pipeline.py --input examples/ANNUAL_REPORT_NVIDIA_2024.pdf --num-samples 10
python run_complete_pipeline.py --input examples/ --num-samples 10
```
...
result = run_rare_pipeline(
    ...
    steps=[
        "parsing",
        "chunking",
        "atomic_info_extraction",
        "atomic_info_selection",
...
python run_complete_pipeline.py --input examples/ANNUAL_REPORT_NVIDIA_2024.pdf --num-samples 5 --output-dir outputs
```
