...
- Group-level metrics covering coverage, PerfRecall, ranking quality, and reciprocal rank
...
### Finance
| Model | Coverage@10 | PerfRecall@10 | NDCG@10 | MRR |
|-------|-------------|---------------|---------|-----|
| BM25 | 59.87 | 36.12 | 48.53 | 36.12 |
| OpenAI-Large | 67.67 | 42.95 | 56.28 | 42.12 |
| BGE-M3 (0.56B) | 64.43 | 39.84 | 52.59 | 39.25 |
| Qwen3 (0.6B) | 67.62 | 43.88 | 54.85 | 40.39 |
| Qwen3 (4B) | 72.43 | 48.84 | 59.35 | 44.00 |
| Qwen3 (8B) | 72.92 | 47.44 | 60.35 | 44.78 |
| Gemma (0.3B) | 40.41 | 20.78 | 30.49 | 21.85 |
| Jina-v4 (3.75B) | 65.10 | 40.31 | 55.09 | 42.08 |
...
| BGE-M3 (0.56B) | 81.82 | 59.58 | 67.37 | 51.04 |
...
| E5-Large (0.56B) | 80.21 | 60.62 | 64.91 | 48.20 |
...
| Gemma (0.3B) | 20.15 | 8.26 | 12.63 | 7.67 |
| Jina-v4 (3.75B) | 59.57 | 34.55 | 47.42 | 34.03 |
| E5-Large (0.56B) | 52.56 | 30.91 | 40.81 | 29.00 |
| E5-Mistral (7B) | 56.86 | 34.05 | 43.34 | 30.97 |

### General-Wiki (Low Redundancy & Low Similarity)
| Model | Coverage@10 | PerfRecall@10 | NDCG@10 | MRR |
|-------|-------------|---------------|---------|-----|
| BM25 | 64.58 | 44.19 | 61.80 | 48.63 |
| OpenAI-Large | 92.78 | 86.48 | 92.17 | 70.24 |
| BGE-M3 (0.56B) | 90.60 | 82.27 | 89.60 | 68.60 |
| Qwen3 (0.6B) | 89.96 | 78.78 | 88.77 | 68.00 |
| Qwen3 (4B) | 93.97 | 89.83 | 92.93 | 70.49 |
...
- **PerfRecall@k**: Binary metric - 1.0 if ALL information types are found in top-k, 0.0 otherwise (JSON field: `perfect_match@k`)
...
- **Complete vs Partial**: PerfRecall requires 100% coverage, coverage allows partial success

**Example**: For gold groups `[(A,B), C, D]` representing 3 information types:
- Retrieved `[A, C, D]` → Coverage@10=1.0, PerfRecall@10=1.0 ✅
- Retrieved `[B, C, D]` → Coverage@10=1.0, PerfRecall@10=1.0 ✅
- Retrieved `[A, B, C]` → Coverage@10=0.67, PerfRecall@10=0.0 ❌ (missing type D)
