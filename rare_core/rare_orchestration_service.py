...
def run_rare_pipeline(
    ...
    num_samples: int = STEP7_SETTINGS.num_samples,
...
class RareOrchestrator:
    ...
    def _step7_legacy_hotpot_flow(
        ...
        gold_sentence_groups = self._convert_redundancy_to_gold_sentences(redundancy_mapping, num_samples)
        ...
        final_questions = multihop_questions[:num_samples]
    ...
    def _convert_redundancy_to_gold_sentences(
        ...
        for mapping in redundant_groups[:num_samples * 2]:  # Process more than target for better selection
