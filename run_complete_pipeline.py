...
from rare_entities import DEFAULT_MODEL, LANGUAGE, STEP7_SETTINGS
...
def main():
    ...
    # Pipeline options
    parser.add_argument("--num-samples", type=int, default=STEP7_SETTINGS.num_samples,
                       help=f"Number of samples to generate (default: {STEP7_SETTINGS.num_samples})")
    parser.add_argument("--model", type=str, default=DEFAULT_MODEL,
                       help=f"LLM model to use (default: {DEFAULT_MODEL})")
    parser.add_argument("--language", type=str, default=LANGUAGE,
                       help=f"Language for generation (default: {LANGUAGE})")
